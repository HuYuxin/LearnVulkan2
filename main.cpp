...
private:
    ...
    void createDepthResources() {
        ...
        createImage(mSwapChainExtent.width, mSwapChainExtent.height, 1, mMsaaSamples, depthFormat,
    ...
    void drawFrame()
    {
        ...
        recordCommandBuffer(mCommandBuffers[mCurrentFrame], imageIndex, mCurrentFrame);
