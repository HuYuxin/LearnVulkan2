...
void Cube::createCubeTextureImage(VulkanInstance& vulkanInstance) {
    ...
    transitionImageLayoutOnetimeSubmit(vulkanInstance, mCubeTextureImage, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, mMipLevels);
